...
% OPTS = { '-switch' | '-coll-end' | '-end-coll' | '-var' VECS | '-no-var' }
%
...
%        ODE_COLL2COLL to switch branches at the solution point, which must
%        then be a branch point. Either '-coll-end' or '-end-coll' marks
%        the end of input to ODE_COLL2COLL. The option '-var' indicates the
...
%        is given by the content of VECS. Alternatively, the option
...
% $Id: ode_coll2coll.m 3315 2024-09-02 16:42:22Z hdankowicz $
